...
function App() {
  ...
  const handleClick = () => {
    // dispatch(requestUserPosts({userId: 1, dispatchId: 1}));
    // dispatch(requestUserPosts({userId: 1, dispatchId: 2}));
    // dispatch(requestUserPosts({userId: 1, dispatchId: 3}));
    // dispatch(requestUserPosts({userId: 1, dispatchId: 4}));

    try {
      for (let dispatchId = 1; dispatchId <= 4; dispatchId++) {
        dispatch(requestUserPosts({userId: 1, dispatchId}))
      }
    } catch (e) {
